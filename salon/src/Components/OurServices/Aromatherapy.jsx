...
function AromatherapyPage() {
  return (
    <div className="lg:w-[73vw]">
      <div className="px-4 py-8 md:p-12 lg:px-16 ">
        <h1 className="text-[55px] font-bold">Aromatherapy</h1>
        <div className="md:flex gap-14 lg:mt-8">
          <div className="lg:w-[70%]">
            <p className="my-3 text-[18px] lg:text-[22px]">
              Aromatherapy uses aromatic materials, including essential oils,
              and other aroma compounds, with claims for improving psychological
              or physical well-being. It is offered as a complementary therapy
              or as a form of alternative medicine, the first meaning alongside
              standard treatments, the second instead of conventional,
