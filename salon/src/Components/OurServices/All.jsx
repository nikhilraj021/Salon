...
const All = () => {
  const cards = [
    ...
    },
    {
      title: "Bridal Makeup",
      description:
        "Every bride wants to look her absolute best on her wedding day. While the wedding dress is key, the bridal makeup looks you choose are just as important for achieving a flawless bridal beauty. Traditional bridal makeup focuses on enhancing the bride's natural beauty with a timeless and elegant style.",
      image:
        "https://images.squarespace-cdn.com/content/v1/55353879e4b0995b98f4fede/1575507572453-K4ONS37III7AMKFZDQIO/image-asset.jpeg",
      icon: "https://images.pexels.com/photos/1185617/pexels-photo-1185617.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
      link: "/ourServices/bridal",
    },
  ];
