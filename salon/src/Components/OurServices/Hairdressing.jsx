...
function HairdressingPage() {
  return (
    <div className="lg:w-[73vw]">
      <div className="px-4 py-8 md:p-12 lg:px-16 ">
        <h1 className=" text-[40px] lg:text-[55px] font-bold">Hairdressing</h1>
        <div className="md:flex gap-14 lg:mt-8">
          <div className="lg:w-[70%]">
            <p className="my-3 text-[18px] lg:text-[22px]">
              ...
              Ancient art drawings and paintings have been discovered depicting
              people working on another person’s hair. Greek writers
              Aristophanes and Homer both mention hairdressing in their
              writings. In Africa, it was believed in some cultures that a
              person’s spirit occupied his or her hair, giving hairdressers high
              status within these communities. The status of hairdressing
              encouraged many to develop their skills, and close relationships
              were built between hairdressers and their clients. Hours would be
              spent washing, combing, oiling, styling and ornamenting their
              hair. Men would work specifically on men, and women on other
              women. Before a master hairdresser died, they would give their
