  ...
  return (
    <div className="lg:w-[73vw]">
      <div className="px-4 py-8 md:p-12 lg:px-16 ">
        <h1 className="text-[55px] font-bold">Massages</h1>
        <div className="md:flex gap-14 lg:mt-8">
          <div className="lg:w-[70%]">
            <p className="my-3 text-[18px] lg:text-[22px]">
              Massage is the manipulation of soft tissues in the body. Massage
              techniques are commonly applied with hands, fingers, elbows,
              knees, forearms, feet, or a device. The purpose of massage is
              generally for the treatment of body stress or pain. A person who
              was professionally trained to give massages was traditionally
              known as a masseur (male) or a masseuse (female), but those titles
              are outmoded, and carry some negative connotations. In the United
              States, the title massage therapist has been recognized as a
              business norm for those who have been professionally trained to
              give massages.
            </p>
