  ...
  return (
    <div className="lg:w-[73vw]">
      <div className="px-4 py-8 md:p-12 lg:px-16 ">
        <h1 className="text-[55px] font-bold">Cosmetics</h1>
        <div className="md:flex gap-14 lg:mt-8">
          <div className="lg:w-[70%]">
            <p className="my-3 text-[18px] lg:text-[22px]">
              ...
              cosmetics are designed for use of applying to the face, hair, and
              body. They are generally mixtures of chemical compounds; some
              being derived from natural sources (such as coconut oil), and some
              being synthetics or artificial. Cosmetics applied to the face to
              enhance its appearance are often called make-up or makeup. Common
              make-up items include: lipstick, mascara, eye shadow, foundation,
              blush, and contour. Other common cosmetics can include skin
              cleansers, body lotions, shampoo and conditioner, hairstyling
              products (gel, hair spray, etc.), perfume and cologne.
            </p>
