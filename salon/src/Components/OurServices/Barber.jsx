  ...
  return (
    <div className="lg:w-[73vw]">
      <div className="px-4 py-8 md:p-12 lg:px-16 ">
        <h1 className="text-[55px] font-bold">Barber</h1>
        <div className="md:flex gap-14 lg:mt-8">
          <div className="lg:w-[70%]">
            <p className="my-3 text-[18px] lg:text-[22px]">
              ...
              instances, barbershops are also public forums. They are the
              locations of open debates, voicing public concerns, and engaging
              citizens in discussions about contemporary issues.
            </p>
